              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dbdbdb">
                <tr class="ui-widget-header">
								...
								<tr>
									...
									<td height="25" align="left" bgcolor="#FFFFFF">
										<input name="isContainCat" type="checkbox" id="isContainCat" value="1" size="5"/>
									</td>
								</tr>
								...
								<tr>
									...
									<td height="25" align="left" bgcolor="#FFFFFF">
										<textarea name="description" id="description" class="textarea ui-widget-content ui-corner-all"></textarea>
									</td>
								</tr>
