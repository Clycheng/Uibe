    ...
    <div id="main-contain-tabs">
     ...
     <div id="main-contain-tabs-1"> 
        <div style="padding:10px">
          ...
          当前位置：<a href="../user/list.php">学员管理</a> &gt; <a href="list.php?userId=<?=$userId?>">考试成绩</a> &gt; 添加考试成绩
        </div>
        <?
          ...
          <div id="tabs">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dbdbdb">
              ...
              <tr>
                ...
                <td width="90%" height="25" align="left" bgcolor="#FFFFFF">
                  <input type="text" name="level" id="level" class="text ui-widget-content ui-corner-all"/>
                </td>
              </tr>
