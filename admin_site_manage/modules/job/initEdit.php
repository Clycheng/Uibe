								...
								<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dbdbdb">
									...
									<tr>
										...
										<td width="40%" height="25" align="left" bgcolor="#FFFFFF">
											...
											<input name="post" type="text" id="post" class="text ui-widget-content ui-corner-all" value="<?=$row->post ?>"/>
										</td>
										<td width="10%" height="25" align="right" bgcolor="#FFFFFF">
											<span class="table_title">工作地点：</span>
										</td>
										<td width="40%" height="25" align="left" bgcolor="#FFFFFF">
										  <input name="address" type="text" id="address" class="text ui-widget-content ui-corner-all" value="<?=$row->address ?>"/>
										</td>
									</tr>
	                    ...
	                    <td width="90%" colspan="3" height="25" align="left" bgcolor="#FFFFFF">
											  ...
											  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#dbdbdb">
											    ...
											    <td width="30%" height="25" align="left" bgcolor="#FFFFFF">
											      <input name="recruterNombre" type="text" id="recruterNombre" value="<?=$row->recruterNombre?>" class="text_seq ui-widget-content ui-corner-all"/>
											    </td>
											    <td width="10%" height="25" align="right" bgcolor="#FFFFFF">
                            <span>发布日期：</span>
                          </td>
                          <td width="30%" height="25" align="left" bgcolor="#FFFFFF">
                            <input type="text" name="issueDate" id="issueDate" readonly="readonly" onClick="WdatePicker({el:'issueDate'})" class="ui-widget-content ui-corner-all" style="width:120px" value="<?=$row->issueDate?>"/>
                          </td>
											    <td width="10%" height="25" align="right" bgcolor="#FFFFFF">
											      <span>排序：</span>
											    </td>
