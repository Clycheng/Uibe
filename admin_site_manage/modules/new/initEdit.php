	                  ...
	                  <td height="25" align="left" bgcolor="#FFFFFF">
	                    ...
	                    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dbdbdb">
	                      ...
	                      <tr>
	                        ...
	                        <td height="25" align="left" bgcolor="#FFFFFF">
	                          <input name="issueDate" type="text" id="issueDate" onClick="WdatePicker({el:'issueDate'})" value="<? if ($row->issueDate != null) { echo date("Y-m-d",strtotime($row->issueDate));}?>" size="15" class="ui-widget-content ui-corner-all" style="width:120px" />
	                        </td>
	                        <td height="25" align="right" bgcolor="#FFFFFF">
	                          <span>作者：</span>
	                        </td>
