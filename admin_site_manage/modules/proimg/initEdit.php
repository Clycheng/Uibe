...
$(function() {
  ...
  $( "#view-zoomImage" ).button().addClass("button");
  $( "#btn_submit" ).button();
  $( "#btn_return" ).button();
  
  $( "#view-smallImage" ).click(function() {
      viewLargerImage($("#smallPic"));
      });

  $( "#view-zoomImage" ).click(function() {
     ...
     <div id="main-contain-tabs-1"> 
        ...
        ?>
            ...
            <div id="tabs-1">
							<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dbdbdb">
								...
								<tr>
									...
									<td width="90%" height="25" align="left" bgcolor="#FFFFFF">
										...
										<input name="piId" type="hidden" value="<?=$row->piId ?>"/>
										<input name="catId" type="hidden" value="<?=$catId ?>"/>
										<input type="text" name="name" id="name" value="<?=$row->name?>"  class="text ui-widget-content ui-corner-all"/>
									</td>
								</tr>
                  ...
                  <td width="90%" height="25" align="left" bgcolor="#FFFFFF">
                    <input type="text" name="smallPic" id="smallPic" value="<?=$row->smallPic?>" class="text ui-widget-content ui-corner-all"/>
                      ...
                      <? } ?>
								...
								<tr>
									...
									<td height="25" align="left" bgcolor="#FFFFFF">
										<input type="text" name="zoomPic" id="zoomPic" value="<?=$row->zoomPic?>" class="text ui-widget-content ui-corner-all"/>
										<input type="button" id="zoomImage" value="选择图片"/>
										 <? if ($row->zoomPic) { ?>
                        <input type="button" id="view-zoomImage" value="图片预览"/>
                      <? } ?>
									</td>
								</tr>
