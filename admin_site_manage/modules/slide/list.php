       ...
       <div id="table-header-contain" class="ui-widget">
         ...
         <div id="table-body-contain" class="ui-widget">
           ...
           <table class="ui-widget ui-widget-content">
              ...
              $pagesize = 10;
              $total = $slideManager->GetSlideCountByCatId($catId);
              if($total == ""){
              ...
              $records = $slideManager->GetSlideListByCatId($catId, $pagingbean->offset(), $pagesize);
              if ($records != null) {
                foreach($records as $record) {
                
              ?>
              <tr>
               <td align="center" bgcolor="#FFFFFF"><?=$record->sId?></td>
                <td height="20" align="center" bgcolor="#FFFFFF">
                  <a href="initEdit.php?action=edit&sId=<?=$record->sId?>&catId=<?=$catId?>" class="liw" title="点击进入编辑页面">
                  <? echo $record->title ?>
                  </a>
                </td>
                <td align="center" bgcolor="#FFFFFF"><?=$record->createTime?></td>
                ...
                <td align="center" bgcolor="#FFFFFF">
                  <a href="initEdit.php?action=edit&sId=<?=$record->sId?>&catId=<?=$catId?>"> 
                  ...
                  &nbsp;
                  <a href="del.php?action=del&sId=<?=$record->sId?>&catId=<?=$catId?>" onClick="return confirmDel();">
                    <span class="ui-state-default ui-corner-all" style="padding:6px 12px 6px 4px; float:right">
