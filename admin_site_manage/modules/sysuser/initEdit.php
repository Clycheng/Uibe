  ...
  <div id="main-contain-tabs">
     ...
     <div id="main-contain-tabs-1"> 
        ...
        <?    
		    ...
		    ?>
		    <form action="edit.php" method="post" name="form1" id="form1">
                  ...
                  <tr class="ui-widget-header">
									...
									<tr>
										...
										<td width="90%" height="25" align="left" bgcolor="#FFFFFF">
											...
											<input name="userName" type="text" id="userName" class="text ui-widget-content ui-corner-all" value="<?=$row->userName ?>"/>
										</td>
									</tr>
									...
									<tr>
										...
										<td height="25" align="left" bgcolor="#FFFFFF">
											<input name="userPwd" type="password" id="userPwd" class="text ui-widget-content ui-corner-all" value=""/>
										</td>
									</tr>
