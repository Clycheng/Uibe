    ...
    <div id="main-contain-tabs">
     ...
     <div id="main-contain-tabs-1"> 
        <div style="padding:10px">
          ...
          当前位置：<a href="list.php">学员管理</a> &gt; 修改学员
        </div>
        <?
            ...
            <div id="tabs-1">
                ...
                <tr>
                  ...
                  <td width="90%" height="25" align="left" bgcolor="#FFFFFF">
                    ...
                    <input name="realName" type="text" id="realName" value="<?=$record->realName?>" class="text ui-widget-content ui-corner-all" />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td height="25" align="left" bgcolor="#FFFFFF">
                    <input name="certificate" type="text" id="certificate" value="<?=$record->certificate?>" class="text ui-widget-content ui-corner-all" />
                  </td>
                </tr>
                    ...
                    <td height="25" align="left" bgcolor="#FFFFFF">
                      ...
                      <?
                       ...
                       foreach ($dictEntryList as $dictEntry) {
                         $seleted = "";
                         if ($dictEntry->entryId == $record->userType) {
                           $seleted=" selected=\"selected\" ";
                         }
                         echo "<option value=\"$dictEntry->entryId\"$seleted>$dictEntry->entryName</option>\n";
                       }
                      ?>
                      </select>
                    </td>
                ...
                <tr>
                  ...
                  <td height="25" align="left" bgcolor="#FFFFFF">
                    <input name="number" type="text" id="number" value="<?=$record->number?>" class="text ui-widget-content ui-corner-all" />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td height="25" align="left" bgcolor="#FFFFFF">
                    <input name="issuedDate" type="text" id="issuedDate" value="<?=$record->issuedDate?>" class="text ui-widget-content ui-corner-all" />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td height="25" align="left" bgcolor="#FFFFFF">
                    <textarea name="audit" id="audit" class="textarea ui-widget-content ui-corner-all"><?=$record->audit?></textarea>
                  </td>
                </tr>
