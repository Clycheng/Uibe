...
{
    var str = '<table Author="alin" class="cdrHeader" cellSpacing="2" cellPadding="#"><tr Author="alin" align="center">\n';
...
Calendar.prototype.getBody = function()
{
   ...
   str += '<table Author="alin" class="cdrBody" cellSpacing="2" cellPadding="#">\n';   
   for(i = 0; i < 6; i++)
	{	  
   ...
   str += '</table>\n';
   str += '<table Author="alin" class="cdrBodyBar" cellSpacing="2" cellPadding="#"><tr align="center" Author="alin"><td Author="alin" style="cursor:pointer;" onclick="'+this.Obj+'.getToday();">今天：'+new Date().toFormatString("yyyy年mm月dd日")+'</td></tr></table>\n';
   return str;
};

Calendar.prototype.getBodyBar = function()
{
   var str = '<table Author="alin_bar" id="cdrBodyBar" class="cdrBodyBar" style="cursor:move;" cellSpacing="2" cellPadding="#"><tr Author="alin_bar" align="center">\n';
...
Calendar.prototype.getYearMenu = function(year)
{
   ...
   var str = '<table Author="alin" cellSpacing="#" class="cdrMenu" cellPadding="#">\n';
   for(i = 0; i < 10; i++)
	{	  
	    var _year = year + i;
   ...
   str += '<tr Author="alin" align="center"><td Author="alin"><table Author="alin" style="font-size:12px;width:100%;" cellSpacing="#" cellPadding="#">\n';
